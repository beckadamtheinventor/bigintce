...
#make install
install: all
	$(CP) $(call NATIVEPATH,src/bigintce.h) $(call NATIVEPATH,$(CEDEV)/include)
	$(CP) $(call NATIVEPATH,bin/BIGINTCE.lib) $(call NATIVEPATH,$(CEDEV)/lib/libload/bigintce.lib)
...
#make clean-install
clean-install:
	$(RM) $(call NATIVEPATH,$(CEDEV)/include/bigintce.h))
	$(RM) $(call NATIVEPATH,$(CEDEV)/lib/libload/bigintce.lib))

.PHONY: all install bigintce clean clean-install
